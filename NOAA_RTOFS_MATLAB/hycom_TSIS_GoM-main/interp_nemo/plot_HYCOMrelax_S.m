% Plot S form NEMO-GLORYS interpolated 
...
dnmb = datenum(2011,5,8);  % interpolation date
...
%
% Get barotrop:
[F,n,m,l] = read_hycom(fina,finb,'salin','r_layer',lplt);
F = squeeze(F);
F(F>huge)=nan;
S = F;
...
stl=sprintf('interp NEMO+GLORYS S to HYCOM, zz0=%7.1fm, %s',zz0,datestr(dnmb));
