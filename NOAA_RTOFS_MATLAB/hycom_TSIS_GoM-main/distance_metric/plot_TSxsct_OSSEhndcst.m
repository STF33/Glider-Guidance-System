...
%  ylim2=min(min(ZZ))-50;
  ylim2=-1500;
	sub_plot_TSxsct(fgn,cmp_sst,XX,ZZ,T,S,cl1,cl2,ylim2);
	sttl = sprintf('T/S (gray=35, black=36), OSSE HYCOM hndcst %s, %s',nmexp,datestr(dnmb)); 
	title(sttl);
