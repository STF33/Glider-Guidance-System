...
%  with persistence
function sub_plotMHD_barsrt_week(nfg,Nfgr,IFCST,CLR,POOL,EXPT,PRST,WK,anls_nm);
...
% Rank by cum score:
    ...
    for ix0=1:length(I)
      ...
      dmm=PRST(ifc).Time(itime).WK(iwk).pw;
      if isempty(dmm); continue; end;
      ...
      clrP = [0.7 0.7 0.7];
      plot([xx1 xx2],[mFc mFc],'-','linewidth',2.,'Color',clrP);
