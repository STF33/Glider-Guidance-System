...
% Get persistence 
% Persistence - control run from HYCOM experiments 1b
    dmean=1;
% Time t0:
...
% Control run:
      ...
      fina=sprintf('%sarchv.%4.4i_%3.3i_00.a',pthd_cntrl,yr,iday);
      finb=sprintf('%sarchv.%4.4i_%3.3i_00.b',pthd_cntrl,yr,iday);
