...
pthfig = '/Net/mars/ddmitry/hycom/hycom_TSIS/fig_ssh_nest/';
...
%  pthd=sprintf('/nexsan/people/ddmitry/hycom/TSIS/IASx0.03/output_gofs3.1_freerun/%4.4i/',year);
  pthd=sprintf('/Net/kronos/ddmitry/hycom/TSIS/nest_files_gofs3.1/%4.4i/',year);
...
for iday=id1:dday:id2
  ...
  hr=0;
  fina = sprintf('%sarchm.GLBb008ias003topo_%i_%3.3i.a',pthd,year,iday);
  finb = sprintf('%sarchm.GLBb008ias003topo_%i_%3.3i.b',pthd,year,iday);
  fin=fina;
...
% Subtract anomaly:
  ...
  date_str=sprintf('%4.4i/%2.2i/%2.2i : %2.2ih',DV(1:4));
  stt=sprintf('Nest GLBb0.08 GOFS3.1 on HYCOM_TSIS IAS0.03, SSH %s',date_str);
  if cntr==1
