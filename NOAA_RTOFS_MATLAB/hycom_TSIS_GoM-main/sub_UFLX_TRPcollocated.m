function [UFLX,TRP] = sub_UFLX_TRPcollocated(BB);
%   For collocated U&V !!!
%
...
%
% Southern OB:
% Note that to make contour closed (for collocated U,V)
% V point on Southern OB needs to end 1/2 grid point 
% of the first U point on the Eastern OB
...
% Western OB:
% First grid point on the West OB 
% with U directed into the contoured volume
% is +1 grid cell from the northern OB
js1=[jSW:jNW]';
