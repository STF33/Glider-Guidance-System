...
#PBS -q standard
#
# Use IAS topo instead of interpolated GLBb topo 09m11
#
module list
set echo
set time = 1
...
setenv TR /nexsan/people/ddmitry/hycom/GLBb0.08_GOFS3.1_expt73.7 
setenv TU /Net/kronos/ddmitry/hycom/TSIS/topo_IAS0.03 
setenv VR 09m11
setenv VU IAS0.03_nest  # depth for nest file with no walls at the N/E OBs
...
#   no leading expt number for nesting files
	setenv FL archm.ias003topo_${YY}_${iday}   # output file with interp archm IAS 0.03
	/bin/rm -f ${N}/${FL}.[ab]
