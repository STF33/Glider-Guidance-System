...
from X_CurrentMapper_Functions import *
from X_CurrentMapper_Config import *
from X_CurrentMapper_Models import *
from X_CurrentMapper_Interpolation import *
from X_CurrentMapper_Products import *
...
def GGS_main(power=1, path="local", config_name=None):
    ...
    '''
    GGS: Current Mapper main function.
...
if __name__ == "__main__":
    GGS_main(power=1, path="local", config_name="sentinel_sd")
