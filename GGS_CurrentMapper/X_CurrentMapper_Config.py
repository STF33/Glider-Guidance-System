...
import json
import os
from X_CurrentMapper_Functions import acquire_gliders
...
def GGS_config_import(config_name):
    ...
    print(f"\n### IMPORTING GGS: CURRENT MAPPER CONFIGURATION: {config_name} ###\n")
...
def GGS_config_process(config, path="default"):
    ...
    print("\n### PROCESSING GGS: CURRENT MAPPER CONFIGURATION ###\n")
