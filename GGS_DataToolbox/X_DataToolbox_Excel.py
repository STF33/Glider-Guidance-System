...
### FUNCTION:
def run_excel(output_directory, glider_info, data_frame):
    ...
    - output_directory (str): The directory to save the output Excel file.
    ...
    output_file = os.path.join(output_directory, f"{glider_unit}-{glider_version}-{glider_type}_DataOutput.xlsx")
