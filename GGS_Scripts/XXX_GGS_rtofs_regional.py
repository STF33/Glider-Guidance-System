...
### FUNCTION:
def model_currents(model_data, mask=False):
...
### FUNCTION:
def GGS_plot_currents(config, waypoints, directory, RTOFS_class, u_avg, v_avg, magnitude, extent='map', show_route=True):
...
def main():
    ...
    GGS_plot_currents(config, waypoints, directory, RTOFS_class, u_avg, v_avg, magnitude, extent='data', show_route=False)
