...
%  function [dip,p_value,xlow,xup]=HartigansDipSignifTest(xpdf,nboot)
%
% calculates Hartigan's DIP statistic 
% and its significance for the empirical p.d.f  XPDF (vector of sample values)
% This routine calls the matlab 
% routine 'HartigansDipTest' that actually calculates the DIP
...
% calculate a bootstrap sample of size NBOOT 
% of the dip statistic for a uniform pdf of 
% sample size N (the same as empirical pdf)
boot_dip=[];
for i=1:nboot
