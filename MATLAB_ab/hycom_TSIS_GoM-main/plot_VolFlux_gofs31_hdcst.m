...
esim3='hindcast_gofs31';  % TSIS assimilative hindcast run

FPLT=[1,1,1]; % experiments to plot
...
if FPLT(3)==1
  cc=cc+1;
  Tr=sub_combine_transp_v2(pthmat,esim3,ys,ye);
  TR(cc).Name=esim3;
  TR(cc).YR=Tr.YR;
  TR(cc).Tb=Tr.Barotrop;
  TR(cc).Ttot=Tr.Total;
...
btx='plot_VolFlux_gofs31_hdcst.m';
