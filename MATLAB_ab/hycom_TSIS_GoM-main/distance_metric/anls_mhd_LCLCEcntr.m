...
if fnrm==1
  title('MHD (km) HYCOM vs NEMO LCLCE contours, 2011/2012');
else
  title('MHD Scores HYCOM vs NEMO LCLCE contours, 2011/2012');
end
...
set(gca,'tickdir','out',...
        ...
        'ygrid','on');
if fnrm==1
  title('Cumulative MHD (km) HYCOM vs NEMO LCLCE contours, 2011/2012');
else
  title('Cumulative MHD Scores HYCOM vs NEMO LCLCE contours, 2011/2012');
end
%lgd = legend('HYCOM osse0','HYCOM osseE','HYCOM free','HYCOM AllSat');
%set(lgd,'position',[0.75 0.8 0.2 0.14]);
xlabel('Months');
...
if fnrm==1
  ylabel('MHD (km)');
  title('Ranking hindcasts, mean MHD (km)');
else
...
if fnrm==1
  ylabel('MHD (km)');
  title('Rankig hindcasts, Mean MHD (km) & 95%CI, LC & LCE contours');
else
  ylabel('MHD Score');
  title('Ranking of the hindcasts (Mean MHD & 95%CI), LC & LCE contours');
end
