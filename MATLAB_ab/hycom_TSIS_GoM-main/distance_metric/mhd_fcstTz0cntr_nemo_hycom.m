...
% (1) interpolated in hycom_TSIS/distance_metric/interp_fcst_hycom2z.m
% (2) extracted in extr_lc_Tz0_fcst_hycom.m
%
...
for itime=1:ntime
  for irun=irun1:irun2
    ...
    fcntrTz = sprintf('%sHYCOM_dT%2.2i_Z%3.3i_contour_%s.mat',...
