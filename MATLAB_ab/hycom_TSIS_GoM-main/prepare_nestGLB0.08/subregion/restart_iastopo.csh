...
date
#
## --- form interpolated subregion restart, GLBb0.08 to IAS0.03
#
...
#
foreach iday ( 001 )
	setenv FLG restart_r2019010109 
#   no leading expt number for nesting files
	setenv FL restart.GLBb008_ias003${YY}_${iday}   # output file with interp archm IAS 0.03
	/bin/rm -f ${N}/${FL}.[ab]
