...
def create_mission(config_name="unknown"):
    ...
    def load_config(file_path):
        ...
        config_dictionary = {
            ...
            'sbdlist': config.get('sbdlist', {}),
            'mbdlist': config.get('mbdlist', {}),
            'tbdlist': config.get('tbdlist', {}),
            'nbdlist': config.get('nbdlist', {})
            }
    ...
    def create_mi_file(config_dictionary, mission_name, output_directory, comments):
        ...
        mission_content += f"# Generated by the Glider Guidance System\n"
        mission_content += f"# Note: Please review all mission files before use\n"
        mission_content += f"##################################################\n"
        mission_content += f"\n"
        mission_content += f"#.....+########*+-+*########+.....\n"
        mission_content += f"#...+#########=##-##=#########+...\n"
...
if __name__ == "__main__":
    create_mission(config_name="unit1000-sandiego-recovery")